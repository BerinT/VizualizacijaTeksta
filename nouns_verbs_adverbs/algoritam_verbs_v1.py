...
fig,ax = plt.subplots()
fig.suptitle('Vizualizacija (verbs) prije korekcije sa pravougaonim granicama')
plt.xlabel('X-osa')
plt.ylabel('Frekvencija pojavljivanja rijeci')
r = fig.canvas.get_renderer()
reader = csv.reader(open('verbs.csv'))
...
fig1.suptitle('Vizualizacija (verbs) nakon korekcije')
plt.xlabel('X-osa')
plt.ylabel('Frekvencija pojavljivanja rijeci')
fig2, ax2 = plt.subplots()
fig2.suptitle('Vizualizacija (verbs) prije korekcije')
plt.xlabel('X-osa')
plt.ylabel('Frekvencija pojavljivanja rijeci')
...
np.save('dictionary2_rezerva_verbs.npy', dictionary2)
# Upisivanje
np.save('dictionary_sp_rezerva_verbs.npy', dictionary_sp)
