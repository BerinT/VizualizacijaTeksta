...
fig,ax = plt.subplots()
fig.suptitle('Vizualizacija (adverbs) prije korekcije sa pravougaonim granicama')
plt.xlabel('X-osa')
plt.ylabel('Frekvencija pojavljivanja rijeci')
r = fig.canvas.get_renderer()
reader = csv.reader(open('adverbs.csv'))
...
np.save('dictionary2_rezerva_adverbs.npy', dictionary2)
# Upisivanje
np.save('dictionary_sp_rezerva_adverbs.npy', dictionary_sp)
