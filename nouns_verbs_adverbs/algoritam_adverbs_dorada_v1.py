...
dictionary2 = np.load('dictionary2_rezerva_adverbs.npy').item()
dictionary_sp = np.load('dictionary_sp_rezerva_adverbs.npy').item()

dictionary2['unfortunately'] = dictionary2['unfortunately'][0],dictionary2['unfortunately'][1],dictionary2['unfortunately'][2] + 0.1, dictionary2['unfortunately'][3]+0.1, dictionary2['unfortunately'][4]
...
fig1.suptitle('Vizualizacija (adverbs) nakon korekcije')
plt.xlabel('X-osa')
plt.ylabel('Frekvencija pojavljivanja rijeci')
fig2, ax2 = plt.subplots()
fig2.suptitle('Vizualizacija (adverbs) prije korekcije')
plt.xlabel('X-osa')
plt.ylabel('Frekvencija pojavljivanja rijeci')
aspectratio = 1.0
for key,values in dictionary2.iteritems():
...
for key,values in dictionary_sp.iteritems():
    ax2.text(values[0],values[2],key)
