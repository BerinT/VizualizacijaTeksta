...
fig,ax = plt.subplots()
fig.suptitle('Vizualizacija prije korekcije sa pravougaonim granicama')
plt.xlabel('X-osa')
plt.ylabel('Frekvencija pojavljivanja rijeci')
r = fig.canvas.get_renderer()
reader = csv.reader(open('text_rdy_v6.csv'))
...
fig1.suptitle('Vizualizacija nakon korekcije')
plt.xlabel('X-osa')
plt.ylabel('Frekvencija pojavljivanja rijeci')
fig2, ax2 = plt.subplots()
fig2.suptitle('Vizualizacija prije korekcije')
plt.xlabel('X-osa')
plt.ylabel('Frekvencija pojavljivanja rijeci')
...
# Upisivanje dictionary2 (nakon korekcije) .npy file
np.save('dictionary2_rezerva.npy', dictionary2)
# Upisivanje sp (start position)
np.save('dictionary_sp_rezerva.npy', dictionary_sp)
